    """
    Text Classifier 5qqtk31
    =======================
    Open-source NLP tool built to summarise text data with state-of-the-art techniques.
    ...
    APP_NAME    = "Text Classifier 5qqtk31"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source NLP tool built to summarise text data with state-of-the-art techniques.")
